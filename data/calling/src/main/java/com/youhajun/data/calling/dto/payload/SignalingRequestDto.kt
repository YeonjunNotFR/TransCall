...
import com.youhajun.data.calling.dto.SubscriberFeedRequestDto
import com.youhajun.data.calling.dto.payload.CompleteIceCandidateDto.Companion.COMPLETE_ICE_CANDIDATE_ACTION_TYPE
import com.youhajun.data.calling.dto.payload.JoinRoomPublisherDto.Companion.JOIN_PUBLISHER_ACTION_TYPE
import com.youhajun.data.calling.dto.payload.JoinRoomSubscriberDto.Companion.JOIN_SUBSCRIBER_ACTION_TYPE
import com.youhajun.data.calling.dto.payload.PublisherOfferDto.Companion.PUBLISHER_OFFER_ACTION_TYPE
import com.youhajun.data.calling.dto.payload.SignalingIceCandidateDto.Companion.ICE_CANDIDATE_ACTION_TYPE
import com.youhajun.data.calling.dto.payload.SubscriberAnswerDto.Companion.SUBSCRIBER_ANSWER_ACTION_TYPE
import com.youhajun.data.calling.dto.payload.SubscriberUpdateDto.Companion.SUBSCRIBER_UPDATE_ACTION_TYPE
...
internal data class JoinRoomPublisherDto(
    ...
    companion object {
        internal const val JOIN_PUBLISHER_ACTION_TYPE: String = "joinPublisher"
    }
}

@Serializable
@SerialName(PUBLISHER_OFFER_ACTION_TYPE)
internal data class PublisherOfferDto(
    @SerialName("offerSdp")
    val offerSdp: String,
    @SerialName("handleId")
    val handleId: Long,
    ...
    companion object {
        internal const val PUBLISHER_OFFER_ACTION_TYPE: String = "publisherOffer"
    }
}

@Serializable
@SerialName(JOIN_SUBSCRIBER_ACTION_TYPE)
internal data class JoinRoomSubscriberDto(
    ...
    companion object {
        internal const val JOIN_SUBSCRIBER_ACTION_TYPE: String = "joinSubscriber"
    }
}

@Serializable
@SerialName(SUBSCRIBER_ANSWER_ACTION_TYPE)
internal data class SubscriberAnswerDto(
    ...
    companion object {
        internal const val SUBSCRIBER_ANSWER_ACTION_TYPE: String = "subscriberAnswer"
    }
}

@Serializable
@SerialName(SUBSCRIBER_UPDATE_ACTION_TYPE)
internal data class SubscriberUpdateDto(
    ...
    companion object {
        internal const val SUBSCRIBER_UPDATE_ACTION_TYPE: String = "subscriberUpdate"
    }
}

@Serializable
@SerialName(ICE_CANDIDATE_ACTION_TYPE)
internal data class SignalingIceCandidateDto(
    @SerialName("handleId")
    val handleId: Long,
    ...
    companion object {
        internal const val ICE_CANDIDATE_ACTION_TYPE: String = "iceCandidate"
    }
}

@Serializable
@SerialName(COMPLETE_ICE_CANDIDATE_ACTION_TYPE)
internal data class CompleteIceCandidateDto(
    @SerialName("handleId")
    val handleId: Long,
) : SignalingRequestDto {
    companion object {
        internal const val COMPLETE_ICE_CANDIDATE_ACTION_TYPE: String = "completeIceCandidate"
    }
}

internal fun SignalingRequest.toDto(): SignalingRequestDto = when (this) {
